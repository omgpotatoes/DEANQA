...
public class Preprocessor {
    ...
    public void annotate(List<String> sentencesOrig) {
    ...
    public static void main(String[] args) {
        ...
        sampleSents.add("Yesterday, Dr. James Howard's dog ate five hundred dollars worth of deluxe seafood biscuits while he was at the opera.");
        sampleSents.add("");
